...
<script>
    var editButton = document.querySelector('.modal-footer');
    ...
    addButton.addEventListener('click', function() {
    	...
    	const row = document.createElement('tr');
		    row.innerHTML = `
		        <td><input type="date" name="tgl"  style="border:none; width: 100%;" placeholder="Date" value=""></td>
		        <td><input type="text" name="unit"  style="border:none; width: 100%;" placeholder="${++tbody.children.length}" value=""></td>
		        <td><input type="text" name="nama"  style="border:none; width: 100%;" placeholder="Item & Description" value=""></td>
		        <td><input type="text" name="harga"  style="border:none; width: 100%;" placeholder="Rate" value=""></td>
		        <td><input type="text" name="jumlah"  style="border:none; width: 100%;" placeholder="Quantity" value=""></td>
		        <td><input type="text" name="total"  style="border:none; width: 100%;" placeholder="Amount" value=""></td>
		        <td><button type="button" class="deleteButton" style="border:none; width: 100%; background-color:transparent; ">❌</button></td>
		    `;
